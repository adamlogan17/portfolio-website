...
const educationDetails: Institution[] = [
	{
		...
		description: {
			...
			description: (
				<>
					At queen's I have learnt about many principles and concepts within the of world software development.
					Throughout all the modules one key area which was highlighted was security. This was stressed within my
					databases, software design principles and in my systems development modules. Another concept which has been
					stressed throughout university is the importance of documentation and the design phase. To this end within
					almost every module I learnt about the nuances of the Unified Modelling Language (UML).
				</>
			)
		},
		role: [
	...
	},
	{
		...
		description: {
			...
			description: (
				<>
					During my time at Belfast High School I built a range of skills and abilities through of my experiences. I was
					a Computing prefect and in this role I went to junior school computing classes and assisted these students in
					their practical work. I also created the rota for this programme, for the assistant prefects, alongside the
					senior prefect. This helped me to develop my leadership and organisational skills.
				</>
			)
		},
		role: [
